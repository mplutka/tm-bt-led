...
const supportedGames = [
    ...
    {
        name: "assetto",
        bin: ["acc.exe", "acr.exe", "assettocorsa.exe"],
        title: ["ASSETTO", "CORSA"]
    },
    // {
    //     name: "assetto-sharedmemory",
    //     bin: ["acc.exe", "acr.exe", "assettocorsa.exe"],
    //     title: ["AC SM", "MODE"]
    // },
    {
        name: "f1",
        bin: ["f1_2019.exe", "f1_2019_dx12.exe", "f1_2020.exe", "f1_2020_dx12.exe", "f1_2021_dx12.exe", "f1_2022_dx12.exe", "f1_23.exe", , "f1_24.exe", "f1_25.exe"],
        title: [" F1 ", "20XX"]
    },
    {
        name: "dirt",
    ...
    {
        name: "rbr",
        bin: ["RichardBurnsRally_SSE", "richardburnsrally.exe","richardburnsrally_sse.exe", "richardburnsrally.exe", "rbr.exe"],
        title: ["RICH", "BURNS"]
    },
    {
        name: "forza",
