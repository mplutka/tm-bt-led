...
const supportedGames = [
    ...
    { name: "_template", bin: [], title: "TEMPLATE" },
    { name: "assetto", bin: ["acc.exe", "assettocorsa.exe"], title: "ASSECORS" },
    { name: "f1", bin: ["f1_2019.exe", "f1_2019_dx12.exe", "f1_2020.exe", "f1_2020_dx12.exe"], title: "F1  20XX" },
    { name: "dirt", bin: ["dirt3_game.exe", "drt4.exe", "drt.exe", "dirtrally2.exe"], title: "DIRTRALLY"},
    { name: "iracing", bin: ["iRacingUI.exe", "iRacingSim64DX11.exe"], title: "iRACING" }
];
