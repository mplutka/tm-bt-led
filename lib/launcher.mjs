...
const supportedGames = [
    ...
    { name: "f1", bin: ["f1_2019.exe", "f1_2019_dx12.exe", "f1_2020.exe", "f1_2020_dx12.exe", "f1_2021_dx12.exe"], title: [" F1 ", "20XX"] },
    { name: "dirt", bin: ["dirt3_game.exe", "drt4.exe", "drt.exe", "dirtrally2.exe"], title: ["DIRT", "RALLY"]},
    { name: "forza", bin: ["forzamotorsport7.exe", "forzahorizon4.exe", "forzahorizon5.exe"], title: [" FOR", "ZA  "]},
    { name: "projectcars2", bin: ["ams2avx.exe", "ams2.exe", "pcars3.exe", "pcars3avx.exe", "pcars2.exe", "pcars2avx.exe"], title: ["PROJECT", "CARS 2"]},
    { name: "iracing", bin: ["iRacingUI.exe", "iRacingSim64DX11.exe"], title: ["IRAC", "ING"] },
    { name: "rF2", bin: ["rFactor2.exe"], title: ["RFAC", "TOR2"] },
    { name: "raceroom", bin: ["RRRE.exe", "RRRE64.exe"], title: ["RACE", "ROOM"] },
    { name: "ets2", bin: ["eurotrucks2.exe"], title: ["EURO", "TRUCK 2"] }
];
