...
class Dirt {
    ...
    constructor() {
        ...
        this.client = new F1TelemetryClient({ port: Dirt.port, bigintEnabled: true });

        this.currentLeftMode = Object.keys(Dirt.leftModes)[0];
        this.currentRightMode = Object.keys(Dirt.rightModes)[0];
    }
    ...
    onDeviceConnected = () =>  {
      ...
      leftPreviousMode = () => {
          const modeKeys = Object.keys(Dirt.leftModes);
          ...
          this.tmBtLed.flashLeftDisplay(Dirt.leftModes[this.currentLeftMode].label);
      ...
      rightPreviousMode = () => {
          const modeKeys = Object.keys(Dirt.rightModes);
          if (modeKeys.length === 0) {
          ...
          this.tmBtLed.flashRightDisplay(Dirt.rightModes[this.currentRightMode].label);
